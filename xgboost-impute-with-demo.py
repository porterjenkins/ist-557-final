...
train_impute = pd.read_csv("data/train_with_demographics_impute.csv",index_col=0)
X_test_impute = pd.read_csv("data/test_with_demographics_impute.csv",index_col=0)
...
impute_data_out_df.to_csv("output/predictions/xgboost_impute_demographics.csv")
