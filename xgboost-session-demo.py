...
train_impute = pd.read_csv("data/train_with_session_demo.csv",index_col=0)
print train_impute.shape
X_test_impute = pd.read_csv("data/test_with_session_demo.csv",index_col=0)
...
impute_data_out_df.to_csv("output/predictions/xgboost_session_demo.csv")
